...
def get_possible_end_situ(session, exec_y, exec_t, exec_n):
	...
	mask_list = [
		...
		((False, None, True, False, False, None, True, None), 4),
		((False, None, False, False, False, None, True, None), 5),
		...
		((False, None, False, True, False, None, True, None), 12),
		((False, True, True, False, False, None, None, None), 13),
		((False, None, True, True, False, None, True, None), 15),
		((False, True, False, False, False, None, None, None), 22),
		((False, None, False, True, True, None, True, None), 90),
		((False, None, False, False, True, None, True, None), 91),
		((None, True, False, True, True, None, None, None), 92),
		((True, None, False, True, True, None, None, None), 92),
		((None, True, True, False, True, None, None, None), 93),
		((True, None, True, False, True, None, None, None), 93),
		((False, None, True, True, True, None, True, None), 94),
		((None, True, True, True, True, None, None, None), 95),
		((True, None, True, True, True, None, None, None), 95),
		((False, None, True, False, True, None, True, None), 96),
